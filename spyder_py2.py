...
class Crawler:
    ...
    def __save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['imgs']:
            try:
                ...
                name = self.__get_name(image_info['objURL'])
                urllib.request.urlretrieve(image_info['objURL'], './' + word + '/' + name)
    ...
    def __get_name(name):
        ...
        if not operator.eq(real_name[len(real_name) - 4: len(real_name)], '.jpg'):
